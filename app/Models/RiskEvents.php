...
class RiskEvents extends Model
{
    ...
    public function get_data_report($year){
        return $this->db->query("
                        ...
                        ORDER BY risk_events.id ASC, risk_mitigations.id, id_detail_mitigation ASC;")->getResultArray();
    }
    ...
    public function get_risk_mitigation_count($year){
        return $this->db->query("SELECT CONCAT('R',_tb.risk_number) as risk_number, _tb.id_detail_mitigation, _tb.risk_mitigation, _tb.id_detail_mitigation, COUNT(_tb.risk_mitigation) as count FROM (
                                SELECT risk_number_manual as risk_number
                                    , risk_event
                                    , risk_mitigation
                            ...
                            ORDER BY _tb.risk_number, _tb.id_risk_mitigation, _tb.id_detail_mitigation;")->getResultArray();
    }
    ...
    public function get_data_report_gabungan($year){
        return $this->db->query("
                    ...
                    , risk_mitigation_detail_monitorings.notes
                    ...
                    GROUP BY risk_mitigation_detail_monitorings.id,risk_mitigation_detail_monitorings.id_detail_mitigation
                    ORDER BY risk_mitigation_details.id")->getResultArray();
    }
    ...
    public function get_data_report_gabungan_2($year){
        return $this->db->query("
                ...
                ORDER BY risk_events.risk_number_manual, risk_mitigation_details.id")->getResultArray();
    ...
    public function get_risk_number_count_gabungan($year){
        return $this->db->query("SELECT CONCAT('R',_tb.risk_number), COUNT(_tb.risk_number) as count FROM 
                                (
                                    SELECT  risk_events.risk_number_manual as risk_number
                                    , risk_events.risk_event
                                    , risk_mitigations.risk_mitigation
                                    , risk_mitigation_details.id as id_detail_mitigation
                                    , risk_mitigation_details.risk_mitigation_detail
    ...
    public function get_risk_mitigation_count_gabungan($year){
        return $this->db->query("
                        ...
                        GROUP BY _tb.risk_mitigation, _tb.risk_number_manual
                        ORDER BY _tb.risk_number_manual, _tb.id_detail_mitigation;")->getResultArray();
    }

    public function get_division_gabungan($year){
        return $this->db->query("
                            SELECT risk_number_manual
                            , risk_events.risk_event
                            , risk_mitigations.risk_mitigation
                            ...
                            , risk_mitigation_details.id as id_detail_mitigation
                            , risk_mitigation_details.risk_mitigation_detail
                            , GROUP_CONCAT(DISTINCT(divisions.name)) as division
                            FROM risk_events 
                            JOIN risk_mitigations on risk_mitigations.id_risk_event = risk_events.id
                            JOIN risk_mitigation_details ON risk_mitigation_details.id_risk_mitigation = risk_mitigations.id
                            JOIN divisions ON divisions.id = risk_mitigation_details.id_division
                            LEFT JOIN risk_mitigation_detail_monitorings ON risk_mitigation_detail_monitorings.id_detail_mitigation = risk_mitigation_details.id
                            WHERE risk_events.year = '".$year."'
                            GROUP BY risk_mitigation_details.risk_mitigation_detail, risk_mitigations.id
                            ORDER BY risk_events.risk_number_manual, risk_mitigation_details.id;")->getResultArray();
    }
