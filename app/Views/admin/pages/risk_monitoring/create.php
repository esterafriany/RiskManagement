<form id="form-add-kpi" action="" class="form-horizontal" method="POST">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="addGroupRiskCategoryLabel">Tambah KPI</h5>
			<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		</div>
		<div class="modal-body">
			<div class="form-group row">
				<label class="control-label col-sm-3 align-self-center mb-0" for="email1">Nama KPI:</label>
				<div class="col-sm-9">
		...
		<div class="modal-footer">
			...
			<button type="button" id="btn-add-kpi"  class="btn btn-primary">Simpan</button>
		</div>
	</div>
</form>
