<form id="form-add-user" action="" class="form-horizontal" method="POST">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="addGroupModalLabel">Tambah User</h5>
		...
		<div class="modal-footer">
			...
			<button type="button" id="btn-add-user"  class="btn btn-primary">Simpan</button>
		</div>
	</div>
</form>
