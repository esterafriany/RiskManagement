...
<script>
	$(document).ready(function() {
		...
		$('#riskMitigationTable').DataTable({
			...
			'ajax': {
				'url': "<?=site_url('RiskMitigationController/getRiskMitigation')?>",
				'data': function(data) {
					// CSRF Hash
				...
				},
				{
					...
					render: function (data, type, item) {
						return '<div class="flex align-items-center list-user-action">'+
                                 '<a href="<?=base_url()?>/admin/detail-risk-mitigation/'+item.id+'" class="btn btn-sm btn-icon btn-warning" title="" data-original-title="Edit" href="#">'+
