...
<script>
				...
				},
				{
					...
					render: function (data, type, item) {
						return '<div class="flex align-items-center list-user-action">'+
								'<a class="btn btn-sm btn-icon btn-warning" href="<?=base_url()?>/risk_owner/get-detail-risk-event/'+item.id+'" title="" data-original-title="Edit" href="#">'+
	...
	function update_risk_table(){
		...
		$('.toggle-vis').on( 'change', function (e) {
			...
			var column = $('#riskEventsTable').DataTable().column( $(this).attr('data-column') );
