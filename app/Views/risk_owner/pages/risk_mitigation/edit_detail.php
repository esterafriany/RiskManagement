<form id="form-edit-detail-mitigation" action="" class="form-horizontal" method="POST">
<input type="hidden" class="form-control" id="id" name="id" placeholder="Masukkan Nama Group">
	<div class="modal-content">
		...
		<div class="modal-footer">
			...
			<button type="button" id="btn-edit-detail_mitigation"  class="btn btn-primary">Simpan</button>
		</div>
	</div>
</form>
